...
import { ArrowRight, Mail, Tv } from "lucide-react";
...
import { TvLoginCode } from "./tv-login-code";

export const metadata: Metadata = {
  title: "Login | Index",
  description: "Login to Index | Access Your Watchlist & More",
  keywords: [
    "Index",
    "Login",
    "Sign In",
...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ tv?: string }> }) {
  ...
  const isTv = /Web0S|WebOS/i.test(userAgent) || params?.tv === 'true';
